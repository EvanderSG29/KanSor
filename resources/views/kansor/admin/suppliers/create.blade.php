...
<div class="card">
    ...
    <form method="POST" action="{{ route('kansor.admin.suppliers.store') }}">
        @csrf
...
<<<<<<< HEAD:resources/views/kansor/admin/suppliers/create.blade.php
=======

>>>>>>> 6549984 (	modified:   .env.example):resources/views/pos-kantin/admin/suppliers/create.blade.php
