...
<div class="card card-outline card-primary">
    ...
    <x-pos.filter-card :action="route('kansor.admin.audit-logs.index')" :reset-url="route('kansor.admin.audit-logs.index')" title="Filter audit log" card-class="border-0 shadow-none mb-0">
            <div class="col-md-4">
...
<<<<<<< HEAD:resources/views/kansor/admin/audit-logs/index.blade.php
=======

>>>>>>> 6549984 (	modified:   .env.example):resources/views/pos-kantin/admin/audit-logs/index.blade.php
