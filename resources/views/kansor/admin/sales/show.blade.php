...
@section('page_header')
    <x-pos.page-header title="Detail Konfirmasi Admin" subtitle="Konfirmasi pembayaran pemasok dan setoran kantin dari detail transaksi yang sama.">
        <x-slot:actions>
            <a href="{{ route('kansor.admin.sales.edit', $sale) }}" class="btn btn-sm btn-outline-primary">Koreksi transaksi</a>
        </x-slot:actions>
    </x-pos.page-header>
@endsection
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card card-outline card-success">
            ...
            <form method="POST" action="{{ route('kansor.admin.sales.confirm-supplier-paid', $sale) }}">
                @csrf
                @method('PATCH')
                <div class="card-body">
                    <dl class="mb-4">
        ...
        <div class="card card-outline card-warning">
            ...
            <form method="POST" action="{{ route('kansor.admin.sales.confirm-canteen-deposited', $sale) }}">
                @csrf
                @method('PATCH')
                <div class="card-body">
                    <dl class="mb-4">
...
<<<<<<< HEAD:resources/views/kansor/admin/sales/show.blade.php
=======

>>>>>>> 6549984 (	modified:   .env.example):resources/views/pos-kantin/admin/sales/show.blade.php
