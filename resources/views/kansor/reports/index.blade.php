    ...
    <div class="col-md-5">
        <div class="card card-outline card-warning">
            ...
            <div class="card-footer">
                <a href="{{ route('kansor.supplier-payouts.index') }}" class="btn btn-outline-warning btn-sm">Kelola payout pemasok</a>
            </div>
        </div>
    </div>
</div>
...
<<<<<<< HEAD:resources/views/kansor/reports/index.blade.php
=======

>>>>>>> 6549984 (	modified:   .env.example):resources/views/pos-kantin/reports/index.blade.php
