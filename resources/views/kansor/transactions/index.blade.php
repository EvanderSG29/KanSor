...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <form method="GET" action="{{ route('kansor.transactions.index') }}">
            <div class="row">
                <div class="col-md-3">
        ...
        <div class="card-footer d-flex justify-content-between align-items-center">
            ...
            <div>
                @if ($pagination['hasPrev'])
                    <a href="{{ route('kansor.transactions.index', array_merge(request()->query(), ['page' => $pagination['page'] - 1])) }}" class="btn btn-outline-secondary btn-sm">Sebelumnya</a>
                @endif
                @if ($pagination['hasNext'])
                    <a href="{{ route('kansor.transactions.index', array_merge(request()->query(), ['page' => $pagination['page'] + 1])) }}" class="btn btn-outline-secondary btn-sm">Berikutnya</a>
                @endif
            </div>
        </div>
    @endif
...
<<<<<<< HEAD:resources/views/kansor/transactions/index.blade.php
=======

>>>>>>> 6549984 (	modified:   .env.example):resources/views/pos-kantin/transactions/index.blade.php
