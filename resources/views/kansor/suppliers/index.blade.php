...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <form method="GET" action="{{ route('kansor.suppliers.index') }}">
...
<<<<<<< HEAD:resources/views/kansor/suppliers/index.blade.php
=======

>>>>>>> 6549984 (	modified:   .env.example):resources/views/pos-kantin/suppliers/index.blade.php
