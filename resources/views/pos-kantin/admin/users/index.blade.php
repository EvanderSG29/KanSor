...
<div class="card card-outline card-primary">
    ...
    <x-pos.filter-card :action="route('pos-kantin.admin.users.index')" :reset-url="route('pos-kantin.admin.users.index')" title="Filter pengguna" card-class="border-0 shadow-none mb-0">
            <div class="col-md-4">
