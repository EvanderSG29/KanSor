...
<body class="@yield('body_class', 'hold-transition sidebar-mini layout-fixed') {{ $isNativeDesktop ? 'kansor-native-desktop' : '' }}">
    ...
    <div class="position-fixed" style="top: 1rem; right: 1rem; z-index: 1080; min-width: 20rem;" id="kansor-toast-stack" aria-live="polite" aria-atomic="true"></div>

    <div class="modal fade" id="kansorConfirmModal" tabindex="-1" role="dialog" aria-labelledby="kansorConfirmModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="kansorConfirmModalLabel">Konfirmasi aksi</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Tutup">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" data-kansor-confirm-message>
                    Apakah Anda yakin ingin melanjutkan aksi ini?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-danger" data-kansor-confirm-approve>Lanjutkan</button>
                </div>
            </div>
        </div>
    </div>
