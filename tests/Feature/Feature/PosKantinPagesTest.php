...
function seedLocalKansorData(User $user): void
{
    seedKansorMirror($user, 'users', [[
        'id' => 'USR-001',
    ...
    seedKansorMirror($user, 'suppliers', [[
        'id' => 'SUP-001',
    ...
    seedKansorMirror($user, 'transactions', [
        [
            'id' => 'TRX-001',
    ...
    seedKansorMirror($user, 'changeEntries', [[
        'id' => 'CHG-001',
    ...
    seedKansorMirror($user, 'supplierPayouts', [[
        'id' => 'PAY-001',
        'supplierId' => 'SUP-003',
...
test('user data stays isolated per local account scope', function () {
    ...
    seedKansorMirror($userA, 'suppliers', [[
        'id' => 'SUP-A',
    ...
    seedKansorMirror($userB, 'suppliers', [[
        'id' => 'SUP-B',
