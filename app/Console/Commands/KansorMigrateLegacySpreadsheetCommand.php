...
class KansorMigrateLegacySpreadsheetCommand extends Command
{
     ...
     */
    public function handle(KansorClient $KansorClient): int
    {
        ...
        try {
            $result = $KansorClient->migrateLegacySpreadsheet([
    ...
    protected function renderMigrationError(KansorException $exception): void
    {
    ...
    protected function isMissingMigrationAction(KansorException $exception): bool
    {
