...
class LoginController extends Controller
{
    ...
    */
    ...
    public function __construct(
        ...
        private KansorSyncService $KansorSyncService,
        private KansorUserAuthenticator $KansorUserAuthenticator,
    ) {
    ...
    {
        $result = $this->KansorUserAuthenticator->attempt(
    ...
    protected function authenticated(Request $request, $user)
    {
        if ($this->resolvedLoginMode === 'online') {
            $syncService = $this->KansorSyncService;
